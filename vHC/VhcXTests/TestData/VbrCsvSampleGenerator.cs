...
""DOMAIN\VeeamViewer"",""Veeam Restore Operator"",""Read-only and restore access""";
        ...
        #region Platform CSV Fixtures

        // Servers CSV header with Platform column (VBR 12.1+)
        private const string ServerHeaderWithPlatform =
            "\"Info\",\"ParentId\",\"Id\",\"Uid\",\"Name\",\"Reference\",\"Description\",\"IsUnavailable\",\"Type\",\"ApiVersion\",\"PhysHostId\",\"ProxyServicesCreds\",\"Cores\",\"CPUCount\",\"RAM\",\"OSInfo\",\"Platform\"";

        // Legacy Servers CSV header without Platform column
