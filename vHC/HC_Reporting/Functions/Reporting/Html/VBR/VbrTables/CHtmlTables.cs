...
namespace VeeamHealthCheck.Html.VBR
{
    ...
    internal class CHtmlTables
    {
        ...
        {
            var section = new CBackupServerSection();
            return section.Render(scrub);
        }
        ...
        {
            var section = new CSecuritySummarySection();
            return section.Render(scrub);
        }
        ...
        {
            var section = new CInfraChipSection();
            return section.Render(scrub);
        }
        ...
        {
            var table = new CMissingJobsTable();
